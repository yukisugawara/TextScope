...
const translations = {
  en: {
    ...
    // About
    'about.title': 'About TextScope',
    'about.intro': 'TextScope is an open-source quantitative text analysis and visualization tool. Upload a document and explore its content through a variety of analytical lenses — all processed locally in your browser.',
    'about.features': 'Key Features',
    'about.freq': 'Frequency Analysis — Word frequency tables with POS tagging and TF-IDF scoring',
    'about.kwic': 'KWIC — Key Word In Context concordance for examining word usage patterns',
    'about.cloud': 'Word Cloud — Visual representation of word frequencies',
    'about.trends': 'Trends — Track word frequency changes across document segments',
    'about.cooccurrence': 'Co-occurrence — Network graph of words appearing together with centrality metrics',
    'about.correspondence': 'Correspondence Analysis — 2D mapping of word and segment relationships',
    'about.cluster': 'Clustering — Hierarchical grouping of similar words via dendrograms',
    'about.topics': 'Topic Modeling — Discover latent topics with LDA and NMF algorithms',
    'about.w2v': 'Word2Vec — Word embedding visualization for semantic similarity',
    'about.coding': 'Coding — Define Boolean search rules to create custom analytical concepts',
    'about.compare': 'Compare — Side-by-side word frequency comparison across multiple documents',
    'about.start': 'Getting Started',
    'about.startDesc': 'Upload a text file or select a built-in sample dataset, then switch between analysis tabs to explore your text from different angles.',
  ...
  ja: {
    ...
    'export.format': '\u5f62\u5f0f',
    // About
    'about.title': 'TextScope \u306b\u3064\u3044\u3066',
    'about.intro': 'TextScope \u306f\u30aa\u30fc\u30d7\u30f3\u30bd\u30fc\u30b9\u306e\u5b9a\u91cf\u30c6\u30ad\u30b9\u30c8\u5206\u6790\u30fb\u53ef\u8996\u5316\u30c4\u30fc\u30eb\u3067\u3059\u3002\u30c9\u30ad\u30e5\u30e1\u30f3\u30c8\u3092\u30a2\u30c3\u30d7\u30ed\u30fc\u30c9\u3057\u3001\u3055\u307e\u3056\u307e\u306a\u5206\u6790\u624b\u6cd5\u3067\u30c6\u30ad\u30b9\u30c8\u3092\u63a2\u7d22\u3067\u304d\u307e\u3059\u3002\u3059\u3079\u3066\u306e\u51e6\u7406\u306f\u30d6\u30e9\u30a6\u30b6\u4e0a\u3067\u30ed\u30fc\u30ab\u30eb\u306b\u5b9f\u884c\u3055\u308c\u307e\u3059\u3002',
    'about.features': '\u4e3b\u306a\u6a5f\u80fd',
    'about.freq': '\u983b\u5ea6\u5206\u6790 \u2014 \u54c1\u8a5e\u30bf\u30b0\u4ed8\u304d\u5358\u8a9e\u983b\u5ea6\u8868\u3068 TF-IDF \u30b9\u30b3\u30a2\u30ea\u30f3\u30b0',
    'about.kwic': 'KWIC \u2014 \u6587\u8108\u4ed8\u304d\u30ad\u30fc\u30ef\u30fc\u30c9\u4e00\u89a7\u3067\u7528\u6cd5\u30d1\u30bf\u30fc\u30f3\u3092\u78ba\u8a8d',
    'about.cloud': '\u30ef\u30fc\u30c9\u30af\u30e9\u30a6\u30c9 \u2014 \u5358\u8a9e\u983b\u5ea6\u306e\u8996\u899a\u7684\u8868\u73fe',
    'about.trends': '\u30c8\u30ec\u30f3\u30c9 \u2014 \u30bb\u30b0\u30e1\u30f3\u30c8\u3054\u3068\u306e\u5358\u8a9e\u983b\u5ea6\u63a8\u79fb\u3092\u8ffd\u8de1',
    'about.cooccurrence': '\u5171\u8d77\u30cd\u30c3\u30c8\u30ef\u30fc\u30af \u2014 \u4e2d\u5fc3\u6027\u6307\u6a19\u4ed8\u304d\u306e\u5171\u8d77\u95a2\u4fc2\u30b0\u30e9\u30d5',
    'about.correspondence': '\u30b3\u30ec\u30b9\u30dd\u30f3\u30c7\u30f3\u30b9\u5206\u6790 \u2014 \u5358\u8a9e\u3068\u30bb\u30b0\u30e1\u30f3\u30c8\u306e\u95a2\u4fc2\u30922D\u7a7a\u9593\u306b\u30de\u30c3\u30d4\u30f3\u30b0',
    'about.cluster': '\u30af\u30e9\u30b9\u30bf\u30ea\u30f3\u30b0 \u2014 \u30c7\u30f3\u30c9\u30ed\u30b0\u30e9\u30e0\u306b\u3088\u308b\u985e\u4f3c\u5358\u8a9e\u306e\u968e\u5c64\u7684\u30b0\u30eb\u30fc\u30d4\u30f3\u30b0',
    'about.topics': '\u30c8\u30d4\u30c3\u30af\u30e2\u30c7\u30ea\u30f3\u30b0 \u2014 LDA\u30fbNMF \u30a2\u30eb\u30b4\u30ea\u30ba\u30e0\u3067\u6f5c\u5728\u30c8\u30d4\u30c3\u30af\u3092\u767a\u898b',
    'about.w2v': 'Word2Vec \u2014 \u5358\u8a9e\u57cb\u3081\u8fbc\u307f\u306b\u3088\u308b\u610f\u5473\u7684\u985e\u4f3c\u6027\u306e\u53ef\u8996\u5316',
    'about.coding': '\u30b3\u30fc\u30c7\u30a3\u30f3\u30b0 \u2014 \u30d6\u30fc\u30eb\u691c\u7d22\u30eb\u30fc\u30eb\u3067\u30ab\u30b9\u30bf\u30e0\u5206\u6790\u30b3\u30f3\u30bb\u30d7\u30c8\u3092\u5b9a\u7fa9',
    'about.compare': '\u6bd4\u8f03 \u2014 \u8907\u6570\u30c9\u30ad\u30e5\u30e1\u30f3\u30c8\u9593\u306e\u5358\u8a9e\u983b\u5ea6\u3092\u4e26\u3079\u3066\u6bd4\u8f03',
    'about.start': '\u306f\u3058\u3081\u306b',
    'about.startDesc': '\u30c6\u30ad\u30b9\u30c8\u30d5\u30a1\u30a4\u30eb\u3092\u30a2\u30c3\u30d7\u30ed\u30fc\u30c9\u3059\u308b\u304b\u3001\u30b5\u30f3\u30d7\u30eb\u30c7\u30fc\u30bf\u3092\u9078\u629e\u3057\u3001\u5206\u6790\u30bf\u30d6\u3092\u5207\u308a\u66ff\u3048\u3066\u3055\u307e\u3056\u307e\u306a\u89d2\u5ea6\u304b\u3089\u30c6\u30ad\u30b9\u30c8\u3092\u63a2\u7d22\u3057\u3066\u304f\u3060\u3055\u3044\u3002',
